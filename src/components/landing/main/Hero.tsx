    ...
    <section className="py-42 text-center hero">
        <Container>
            <div className=" max-w-2xl mx-auto">
                ...
                <h1 className="font-semibold text-5xl text-white  mt-2 mb-4 leading-[1.25] text-balance uppercase">Conectando Ideas y Talento Universitario</h1>
                <p className="uppercase text-white/70 text-balance ">Explora proyectos, conecta con mentors y encuentra
